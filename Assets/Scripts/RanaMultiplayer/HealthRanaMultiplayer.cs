...
public class HealthRanaMultiplayer : MonoBehaviour
{
    TimeControllerRanaMultiplayer timeControllerRana;
    public int sin_tp = 0;
    ...
    void Start()
    {
        timeControllerRana = GameObject.Find("PanelTiempo").GetComponent<TimeControllerRanaMultiplayer>();
