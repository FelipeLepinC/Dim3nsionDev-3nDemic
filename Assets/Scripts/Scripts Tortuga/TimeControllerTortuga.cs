...
public class TimeControllerTortuga : MonoBehaviour
{
    ...
    public ContadorTortugas contadores;
    ...
    IEnumerator puntuaciones(){
        puntajeTexto.text = "" + (int)contadores.rescatadas;
    ...
    private int CalculoMedalla(){
        puntos = (int)contadores.rescatadas;
